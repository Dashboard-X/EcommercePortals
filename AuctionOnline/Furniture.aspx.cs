...
namespace AuctionOnline
{
    public partial class WebForm6 : System.Web.UI.Page
    {
        ...
        private void add()
        {
            adp = new SqlDataAdapter("select image,p_id,p_name from product join productgroup on product.pt_id=productgroup.pt_id where product_type='Furniture' and status='Stock' order by p_id desc ", con);
            adp.Fill(set);
            Table tbl = new Table();
