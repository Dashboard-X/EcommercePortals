...
namespace AuctionOnline
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Page.IsPostBack)
            {
                pg(TextBox1.Text, DropDownList1.SelectedValue.ToString());
            }
        }
        ...
        protected void pg(string query, string wher)
        {
            adp = new SqlDataAdapter("select image,p_id,p_name from product where " + wher + " like'%" + query + "%' and status='stock' ", con);
            adp.Fill(set);
            Table tbl = new Table();
